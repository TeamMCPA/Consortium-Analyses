...
for s_idx = 1:n_subj    
    ...
    [train_data, train_labels, test_data, test_labels] = split_test_and_train(s_idx,...
        allsubj_results.conditions,...  % this field covers only conditions of interest to be used in the classifier analysis
        allsubj_results.patterns,...
        allsubj_results.event_types,... % this field covers all conditions found in onsets matrix, not just conditions of interest
