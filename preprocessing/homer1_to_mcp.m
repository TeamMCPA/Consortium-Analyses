function MCP_Struct = homer1_to_mcp(data_file, subject_id, probe_array_id, marks_matrix_name)

%HOMER1_to_MCP Grabs data from the struct in a Homer1-formatted .nirs file
...
if isempty(subject_id)
    MCP_Struct.Subject.Subject_ID = raw_nirs_file.hmr.subjectNum{:};
else
...
MCP_Struct.Experiment.Probe_arrays.Channels_in_Array = 1 : size(raw_nirs_file.hmr.data.dConc, 3); % channels
