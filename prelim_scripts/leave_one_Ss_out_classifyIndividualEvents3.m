function allsubj_results = leave_one_Ss_out_classifyIndividualEvents3(MCP_file,handle,incl_channels,time_window, cond1,cond2,setsize)
...
MCPA_pattern = summarize_MCPA_Struct(MCP_to_MCPA(MCP_struct,[1:length(MCP_struct)],incl_channels,time_window),handle)
