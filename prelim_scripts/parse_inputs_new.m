...
addParameter(p,'norm_data_participantLevel', false, @islogical);
addParameter(p,'norm_data_groupLevel', false, @islogical);
addParameter(p,'norm_withinSessions', true, @islogical);
addParameter(p, 'norm_function', @minMax_scale);
addParameter(p, 'norm_features', true, @islogical);
